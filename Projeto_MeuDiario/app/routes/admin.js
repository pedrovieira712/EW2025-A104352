...
router.post("/categories/new", (req, res, next) => {
  ...
  axios
    .post(API_URL + "/category", categoryData, config)
    .then((resp) => {
...
router.get("/categories/:id/edit", (req, res, next) => {
  ...
  Promise.all([axios.get(API_URL + "/category/" + id, config), axios.get(API_URL + "/category", config)])
    .then((responses) => {
...
router.post("/categories/:id/edit", (req, res, next) => {
  ...
  axios
    .put(API_URL + "/category/" + id, categoryData, config)
    .then((resp) => {
      res.redirect("/admin/categories")
    })
    .catch((erro) => {
...
router.get("/stats", (req, res, next) => {
  ...
  axios
    .get(API_URL + "/log/stats/summary", config)
    .then((resp) => {
      var stats = resp.data
      res.status(200)
...
router.get("/logs/export", (req, res, next) => {
  ...
  axios
    .get(API_URL + "/log/export/file", config)
    .then((resp) => {
